...
export default function SmartFarmingPlatform() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50">
      ...
      {/* Problem Statement */}
      <section id="problem" className="py-16 bg-gray-50 scroll-mt-24">
      ...
      {/* Farming Methods */}
      <section id="methods" className="py-16 scroll-mt-24">
      ...
      {/* Impact Section */}
      <section id="impact" className="py-16 bg-green-600 text-white scroll-mt-24">
      ...
      {/* Future Plans */}
      <section id="future" className="py-16 bg-gray-50 scroll-mt-24">
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
